...
#   Deterministic baseline:  USE_RR_FEATURES=True,  USE_RISK_HEAD=True, DETERMINISTIC=True
#
...
# --- Paths ---
DATA_FOLDER = "mitdb"
MODEL_DIR   = "checkpoints_no_RR_2"
RESULTS_DIR = "results_no_RR_2"
...
USE_RR_FEATURES = False   # include normalised RR + dRR as 2 extra input channels
